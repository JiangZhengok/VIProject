...
//#include "magnetic/dmc_msgs.h" //@jiang

//extern std::mutex dmc_mbuf; //@jiang
//extern queue<magnetic::dmc_msgs> dmc_buf; //@jiang
...
void PoseGraph::addKeyFrame(KeyFrame* cur_kf, bool flag_detect_loop)
{
    ...
    /***********@jiang******************/
   /* if(cur_kf -> index == 0) //是否是第一帧
    {
        dmc_mbuf.lock();   
        float Angle_theta = -dmc_buf.front().Tpitch;        
        Eigen::AngleAxisd roatation_vector( Angle_theta * M_PI / 180, Eigen::Vector3d(0, 0, 1) ); //Vector3f::UnitZ()
        R = R * roatation_vector.toRotationMatrix();
        dmc_mbuf.unlock();
    }*/
    /**********************************/
    ...
    /***********@jiang******************/   
    /*Eigen::Vector3d euler_curAngles = R.eulerAngles(2, 1, 0);
    euler_curAngles[0] = 90 * M_PI / 180; //-dmc_buf.front().Tpitch * M_PI / 180;
    Eigen::AngleAxisd angleAxis2 = Eigen::AngleAxisd(euler_curAngles[0], Eigen::Vector3d::UnitZ());
    Eigen::AngleAxisd angleAxis1 = Eigen::AngleAxisd(euler_curAngles[1], Eigen::Vector3d::UnitY());
    Eigen::AngleAxisd angleAxis0 = Eigen::AngleAxisd(euler_curAngles[2], Eigen::Vector3d::UnitX());
    
    R = angleAxis2.matrix() * angleAxis1.matrix() * angleAxis0.matrix();*/
    /**********************************/
    /***********@jiang******************/   
        /*Eigen::Vector3d euler_curAngles; //= R.eulerAngles(2, 1, 0);
        euler_curAngles[0] =  -dmc_buf.front().Tpitch * M_PI / 180;  //-dmc_buf.front().Tpitch * M_PI / 180;
        euler_curAngles[1] = 0;
        euler_curAngles[2] = 0;
        Eigen::AngleAxisd angleAxis2 = Eigen::AngleAxisd(euler_curAngles[0], Eigen::Vector3d::UnitZ());
        Eigen::AngleAxisd angleAxis1 = Eigen::AngleAxisd(euler_curAngles[1], Eigen::Vector3d::UnitY());
        ...
        Matrix3d CurRotation = angleAxis2.matrix() * angleAxis1.matrix() * angleAxis0.matrix();
        P = CurRotation * P;
    /**********************************/
