...
//queue<magnetic::dmc_msgs> dmc_buf; //@jiang
//std::mutex dmc_mbuf; //@jiang
...
/********************@jiang****************************/
/*void dmc_callback(const magnetic::dmc_msgs &dmc_msg)
{
    dmc_mbuf.lock();
    dmc_buf.push(dmc_msg);
    if( dmc_buf.size() >= 10 )
        dmc_buf.pop();
    dmc_mbuf.unlock();
}
...
int main(int argc, char **argv)
{
    ...
    //ros::Subscriber sub_dmc = n.subscribe("/dmc_data", 2000, dmc_callback); //@jiang
